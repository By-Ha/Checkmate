...
$(() => {
    ...
    $(() => {
        ...
        s.on('UpdateSettings', function (dat) {
            ...
            $("#settings-gamemap button[data=" + dat.map + "]").removeClass("btn-outline-primary");
            $("#settings-gamemap button[data=" + dat.map + "]").addClass("btn-primary");
        });
    });
    ...
    if (s2['time'] == undefined || s2['time'] <= t - 1000 * 300 || s2['times'] >= 15) {
        ...
        if (s2['times'] >= 15) window.location.href = '/';
    }
});