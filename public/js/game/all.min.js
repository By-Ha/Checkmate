...
$(() => {
    ...
    $(() => {
        ...
        s.on('UpdateSettings', function (dat) {
            ...
            $("#settings-gamemap button").removeClass("btn-primary");
            $("#settings-gamemap button").addClass("btn-outline-primary");
            $("#settings-gamemap button[data=1]")[0].innerHTML = `随机地图${dat.map[1]}`;
            $("#settings-gamemap button[data=2]")[0].innerHTML = `迷宫地图${dat.map[2]}`;
            $("#settings-gamemap button[data=3]")[0].innerHTML = `空白地图${dat.map[3]}`;
        });
    });
